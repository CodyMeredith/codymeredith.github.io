this.wordle = this.wordle || {}, this.wordle.bundle = function (e) {
    ...
    var Ma = ["wrike", "agile", "avoid", "chart", "gantt", "brief", "burst", "value", "capex", "study", "phase", "fixed", "float", "issue", "merge", "prism", "rasci", "scope", "scrum", "slack", "cycle", "start", "story", "limit", "model"],
